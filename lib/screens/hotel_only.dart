...
class HotelOnly extends StatefulWidget {
  static const String id = "hotel_only";

  @override
  _HotelOnlyState createState() => _HotelOnlyState();
}

class _HotelOnlyState extends State<HotelOnly> {
  @override
